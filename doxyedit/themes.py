...
SLATE = Theme(
    name="Slate",
    # Backgrounds darkened ~25 luminance steps so near-white text
    # clears AAA on bg_main / bg_raised. Pre-fix bgs lived in the
    # 80-100 luminance range and produced 5-6:1 ratios.
    bg_deep="#1c2028",
    bg_main="#262c34",
    bg_raised="#323840",
    bg_input="#2a3038",
    ...
    text_muted="#9ca8b8",
    # text_on_accent on the bright cyan #4ba8ec scored 2.6:1 with
    # white. Black scores 8:1.
    text_on_accent="#0e1820",
    statusbar_bg="#0e1820",
...
MOSS = Theme(
    name="Moss",
    # Backgrounds darkened so cream text clears AAA.
    bg_deep="#1e2418",
    bg_main="#262c1c",
    bg_raised="#323a26",
    bg_input="#2c321e",
...
OCEAN = Theme(
    name="Ocean",
    # Backgrounds dropped to deep teal so the near-white text clears
    # AAA. The old mid-luminance set produced 3-4:1 ratios.
    bg_deep="#162228",
    bg_main="#1d2c34",
    bg_raised="#283a44",
    bg_input="#1f2e36",
...
LAVENDER = Theme(
    name="Lavender",
    # Darkened the background tier to push contrast over the WCAG AAA
    # bar against the existing near-white text. Was bg_main=#9c8eb4
    # which produced 2.7:1 against text_primary; now ~7:1.
    bg_deep="#241836",
    bg_main="#2e2042",
    bg_raised="#3a2a52",
    bg_input="#34244c",
    ...
    accent="#a875e0",
    accent_dim="#6848a0",
    accent_bright="#c898f0",
    text_primary="#f6eefa",
    text_secondary="#dccef0",
    text_muted="#a890c0",
    text_on_accent="#1a0e2e",
    statusbar_bg="#1a0e2e",
    statusbar_text="#f6eefa",
    border="#4a3868",
    border_light="#5a4878",
    selection_bg="#6848a0",
    selection_border="#a875e0",
    thumb_bg="#34244c",
    success="#88d080",
    warning="#f0c870",
    error="#f07888",
...
AURORA = Theme(
    ...
    # Lightened from #706890 to clear AA UI contrast (3.0:1) on bg_raised.
    text_muted="#8c84a8",
...
WINE = Theme(
    name="Wine",
    # Backgrounds darkened ~25 luminance steps so near-white text
    # clears AAA against bg_main / bg_raised. Original deep-rose
    # set produced 4.4:1 against text_primary.
    bg_deep="#3e1828",
    bg_main="#4a1e30",
    bg_raised="#582840",
    bg_input="#542438",
    ...
    accent="#a85478",
    accent_dim="#7c2848",
    accent_bright="#c47090",
    text_primary="#fceef4",
    text_secondary="#f4dce6",
    text_muted="#b8889c",
    # Use near-white on the rosé accent — pure black scored 3.9:1
    # (failed AA); white scores 4.6:1 against #a85478.
    text_on_accent="#ffffff",
    statusbar_bg="#1a0810",
